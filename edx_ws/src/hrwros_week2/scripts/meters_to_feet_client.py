...
if __name__ == "__main__":
    ...
    rospy.loginfo("Requesting conversion of %4.2f m to feet"%(distance_meters))

    # Call the service client function.
    service_response = meters_to_feet_client(distance_meters)
    ...
    if(not service_response.success):
        ...
        rospy.loginfo("%4.2f(m) = %4.2f feet"%(distance_meters, service_response.measurement_feet))
